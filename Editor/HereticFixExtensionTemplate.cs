...
namespace RuneFoxMods.HereticFixExtension
{
    ...
    public partial class HereticFixExtensionTemplate : HereticFixExtensionTemplateBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            this.Write("using UnityEngine;\r\nusing System;\r\nusing RoR2;\r\nusing MonoMod.RuntimeDetour;\r\nusi" +
                    "ng RuneFoxMods.HereticFixExtension;\r\n\r\n\r\nnamespace ");
...
");
 foreach(var skin in info.HereticSkins){
            this.Write("        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skin.bodyName + skin.name));
            this.Write("SkinAddedEvent += onSkinAdded;\r\n");
}
            this.Write(@"        _HereticFixManager.TryAddSkinController();
      }
...
");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class HereticFixExtensionTemplateBase
    {
        #region Fields
